...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  ...
  <body>
    <div>
      <table align='center' background='https://shopitnow.ml' border='0' cellpadding='0' cellspacing='0' role='presentation' style='background:#f0f0f0 url(https://shopitnow.ml) top center / cover no-repeat;width:100%;'>
        <tbody>
          <tr>
            <td>
              <!--[if mso | IE]>
<v:rect style="mso-width-percent:1000;" xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false"><v:fill src="https://shopitnow.ml" color="#f0f0f0" origin="0.5, 0" position="0.5, 0" type="tile" /><v:textbox style="mso-fit-shape-to-text:true" inset="0,0,0,0">
<![endif]-->
                          ...
                          <tbody>
                            <tr>
                              <td style='width:600px;'>
                                <img alt='Shopitnow' height='auto' src='https://i.imgur.com/ZwiT80d.png' style='border:none;display:block;font-size:13px;height:auto;outline:none;text-decoration:none;width:100%;' width='600' />
                              </td>
                            </tr>
                          </tbody>
                        </table>
                    ...
                    <tr>
                      <td align='left' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                        <div style='color:#000000;font-family:Helvetica, Arial, sans-serif;font-size:18px;font-weight:light;line-height:28px;text-align:left;'>
                          ...
                          is one of the latest online / offline fashion store, always keep you updated with latest fashion.
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <td align='left' style='font-size:0px;padding:10px 25px;word-break:break-word;' vertical-align='middle'>
                        <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='border-collapse:separate;line-height:100%;'>
                          <tr>
                            <td align='center' bgcolor='BLACK' role='presentation' style='background-color:BLACK;border:none;border-radius:0px;cursor:auto;padding:10px 25px;' valign='middle'>
                              <a href='https://shopitnow.ml' style='background:BLACK;color:#ffffff;font-family:Helvetica, Arial, sans-serif;font-size:18px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;' target='_blank'>
                                Visit our website
                              </a>
                            </td>
                          </tr>
                                  ...
                                  <tbody>
                                    <tr>
                                      <td style='width:250px;'>
                                        <img alt='shopitnow logo' height='auto' src='https://i.imgur.com/4bAkFaf.png' style='border:none;display:block;font-size:13px;height:auto;outline:none;text-decoration:none;width:100%;' width='250' />
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
                              ...
                              <td align='right' style='vertical-align:bottom;' width='34px'>
                                <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='border-collapse:collapse;border-spacing:0px;'>
                                  <tbody>
                                    <tr>
                                      <td style='width:30px;'>
                                        <img alt='Instagram' height='auto' src='https://assets.opensourceemails.com/imgs/lifestyle/BHraIlyShi7koHdeMEbD_icon-linkedin.png' style='border:none;display:block;font-size:13px;height:auto;outline:none;text-decoration:none;width:100%;' width='30' />
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
