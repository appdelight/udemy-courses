...
import { addNewLessonApi, addNewPlaylistApi } from '../../services';
...
const AddNewLesson = (props:Props) => {
    ...
    const handleSubmit = async(e:any) => {
        ...
        try {
            ...
            const result = await addNewLessonApi(payload);
            setLoading(false)
            props.onClose()
        } catch (error) {
            console.error(error)
        ...
        <div className=" add_playlist">
            ...
            <form onSubmit={handleSubmit} className="container form-group p-3">
                ...
                <div className="col-12 text-center">
                    <button onClick={handleClose} type="reset" className="btn btn-outline-danger mx-2">Cancel</button>
                    <button 
                        disabled={(!file && !poster) || !title} 
                        type="submit"
